		...
		<div class="header">
			...
			<div class="h-right">
				...
				<transition name="upshow">
					<div
						class="selector"
						v-show="this.selectorShow"
						@mouseleave="this.closeSelector"
					>
						<div
							class="s-item"
							id="setting"
							@click="this.toAccountSetting"
						>
			...
			<div class="sidebar">
				<div class="nav-box">
					...
					<div class="nav">
						...
						<router-link
							v-show="this.user.type == 'responsible_teacher'"
							to="/home/grade"
							class="nav-item"
							id="course"
						>
		...
		if (!token) {
			...
			API.user
				...
				.then(res => {
					...
					if (this.user.avatar == "") {
						this.user.avatar =
							"http://localhost:3000/upload/avatar_1641746614153_915270754.jpg";
					}
