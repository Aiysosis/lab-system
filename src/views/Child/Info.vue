				...
				<div class="help-main">
					<vue-scroll>
						<div class="help-item">
							...
							<div class="help-a">
								账号信息在注册账号之前由系统自动录入，不排除信息错误的情况，请联系教务或者系统管理员，出示相关证明，我们会为您完成修改。
							</div>
						</div>
						<div class="help-item">
							<div class="help-q">
							...
							<div class="help-a">
								用户基本的个人信息是提前录入系统且无法被修改的，我们为您提供的修改功能包括头像以及简介，其余信息如姓名、学工号、年级、身份都是无法修改的。如果发现基本信息错误，请向教务或管理员反应，账号有关的信息请前往“账户”页面。
							</div>
						</div>
						<div class="help-item">
							<div class="help-q">Q：如何修改个人信息？</div>
							<div class="help-a">
								在页面的“基本信息”标识右侧有修改的按钮，点击即可对部分个人信息进行编辑。
							</div>
						</div>
					</vue-scroll>
				</div>
		...
		>
			...
			>
				...
				<el-form-item label="个人简介" prop="description">
					<el-input
						style="width: 300px"
						v-model="updateUser.description"
					></el-input>
				</el-form-item>
				<el-form-item>
					<el-button
						type="primary"
						@click="submitAnnounce('updateUser')"
						>确认修改</el-button
					>
			...
			<div class="main-container">
				<div class="head-box">
					...
					<div class="head-box-main">
						<div>
							<img
								class="head-box-avatar"
								:src="this.user.avatar"
							/>
						</div>
						<div class="name-description">
							<div class="head-box-name">
								{{ this.user.name }}
							</div>
...
export default {
	...
	mounted() {
		...
		if (this.user.type == "teacher") this.userType = "任课教师";
		else if (this.user.type == "responsible_teacher")
			this.userType = "责任教师";
		else this.userType = "学生";
	},
	computed: {
		moto: function () {
			if (this.user.description == "")
				return "Life is like a box of chocolate, you never konw what you are going to get.";
	...
	methods: {
		...
		updateUserAvatar() {
			...
			console.log(this.updateUser);
			axios
				.updateUser(qs.stringify(this.updateUser))
				.then(res => {
					console.log(res);
					this.editInfo = false;
