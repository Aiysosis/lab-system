				...
				<div class="help-main">
					<vue-scroll>
						<div class="help-item">
							...
							<div class="help-a">
								由于系统功能方面的要求，理论上只要知道其他人的学工号即可进行注册。因此我们无法保证您的信息不被抢注或误注，如果发现您的信息已经被他人注册，请携带身份证明前往教务说明情况，我们会在确认您的身份后为您重置账号。
							</div>
						</div>
						<div class="help-item">
							<div class="help-q">
							...
							<div class="help-a">
								邮箱换绑功能必须通过原有邮箱的验证，因此无法在本系统中完成换绑操作。您可以点击下方的“立即反馈”，以邮件的形式向管理员发送邮件，说明相关情况并出示证明材料，如身份证，学生证正面照片等。您也可以携带身份证明资料前往教务处理。
							</div>
						</div>
						<div class="help-item">
							<div class="help-q">
							...
							<div class="help-a">
								忘记密码或密码被他人篡改时，我们建议您向管理员说明情况并出示身份证明，或者携带身份证明前往教务进行反馈，您可以选择找回密码或者重置您的账户。
							</div>
						</div>
					</vue-scroll>
				</div>
		...
		<div class="main">
			...
			<div class="main-container">
				...
				<div class="account-item">
					...
					<div class="right">
						<div class="account-item-btn" @click="showPswForm()">
							修改密码
						</div>
					</div>
				</div>
