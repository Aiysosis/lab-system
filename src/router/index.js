		...
		children: [
			{
				...
				children: [
					...
					},
					{
						...
						name: "CourseHome",
						component: () =>
							import("../views/Child/CourseHome.vue"),
						...
						children: [
							{
								...
								component: () =>
									import(
										"../views/Child/CourseHome/CourseProject.vue"
									),
							...
							},
							{
								...
								component: () =>
									import(
										"../views/Child/CourseHome/CourseAnnounce.vue"
									),
								meta: { index: 4, requiresAuth: true },
							},
							{
								...
								component: () =>
									import(
										"../views/Child/CourseHome/Practice.vue"
									),
								meta: { index: 4, requiresAuth: true },
							},
							{
								...
								component: () =>
									import(
										"../views/Child/CourseHome/Homework.vue"
									),
								meta: { index: 4, requiresAuth: true },
							},
							{
								...
								component: () =>
									import(
										"../views/Child/CourseHome/CourseGrade.vue"
									),
								meta: { index: 4, requiresAuth: true },
							},
							{
								...
								component: () =>
									import(
										"../views/Child/CourseHome/CourseFiles.vue"
									),
								meta: { index: 4, requiresAuth: true },
							},
						],
